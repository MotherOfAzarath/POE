...
class RangedUnit : Unit
{
    ...
    public RangedUnit(int X_position, int Y_position, int Health, int Attack, int Speed, int Attack_range, int Faction1, string Symbol1, string name1)// meelee unit constructor
    {
        PosX = X_position;
        PosY = Y_position;
        health = Health;
